...
"}"));
        ...
        pushButton_displaySouvenir->setObjectName("pushButton_displaySouvenir");
...
"}"));
        ...
        pushButton_totalseatcapacity->setObjectName("pushButton_totalseatcapacity");
...
"}"));
        ...
        pushButton_bermudaGrass->setObjectName("pushButton_bermudaGrass");
